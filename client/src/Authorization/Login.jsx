    ...
    try {
      ...
      if (response.data.success) {
        ...
        localStorage.setItem(
          "lender",
          JSON.stringify(response.data.lender)
        );
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-600 p-12 text-white flex-col justify-center">
        ...
        <div className="max-w-lg">
          ...
          <p className="mt-6 text-lg text-slate-300">
            Manage parking spaces, reservations, vehicles, and customer
            bookings through a secure and intelligent platform.
          </p>
          ...
          <div className="mt-10 bg-white/10 backdrop-blur-lg rounded-3xl p-6 border border-white/10">
            ...
            <p className="text-slate-300">
              Access your parking locations, monitor reservations,
              manage customers and track earnings in real time.
            </p>
          </div>
